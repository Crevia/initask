                            ...
                            <div class="w-full mb-6 md:mb-0">
                                <div class="flex gap-1 justify-between">
                                    ...
                                    <Transition enter-active-class="transition ease-in-out" enter-from-class="opacity-0"
                                        ...
                                        <p v-if="form.recentlySuccessful" class="text-sm text-gray-100">Saved.</p>
                                    </Transition>
                                </div>
                                <div class="flex gap-1">
                                    <TextInput id="url" type="url" class=" block w-full" v-model="form.url" required
                                        name="url" autofocus />
                                    <button :disabled="form.processing"
                                        class="shadow bg-green-500 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold px-4 rounded"
                                        type="submit">
                                        Shorten
                                    </button>
